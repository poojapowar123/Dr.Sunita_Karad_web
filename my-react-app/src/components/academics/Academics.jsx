...
//           <h3 className="Aca-card-title">Career Overview:</h3>
...
//         <div className="Aca-card">
//           <h3 className="Aca-card-title">Notable Projects & Research:</h3>
//           <p className="Aca-card-text">
//             Dr. Karad’s research spans across diverse domains, from computer 
//             engineering to the integration of technology in education. She has led 
//             and contributed to several innovative projects that have advanced both 
//             academic knowledge and institutional growth. Her scholarly work is 
//             reflected in multiple publications and patents, underscoring her 
//             dedication to research and development.
//           </p>
//           <p className="Aca-card-text">
//             Beyond her own research pursuits, Dr. Karad is a passionate mentor. 
//             She actively guides students, researchers, and faculty members, inspiring 
//             them to pursue inquiry, innovation, and excellence in their respective fields.
//           </p>
//         </div>
//       </div>
//     </div>
